import { HeartHandshake, BookOpen, Home, Utensils, GraduationCap, Stethoscope, Users, Baby, Building2 } from "lucide-react";
...
We are grateful to every volunteer, donor, and partner who made this possible. Watch for our summer drive announcement coming in October.`,
    published: true,
...
In previous years, our school kits included basic stationery. This year, we partnered with three local schools and two mentorship organisations to add:
...
Applications for the 2026 programme open in November. Follow our Updates page for announcements.`,
    published: true,
...
The Community Pantry started as a single Saturday experiment: set up trestle tables, invite families in need, and see what happens. One year later, it has become one of the foundation's most replicated models.

### Three Locations, One Mission

The pantry now operates every weekend at three community centres. Each site is managed by a local volunteer coordinator who receives training and a small operational stipend.

### Community-Led Spin-Offs

Two neighbourhood groups, inspired by the original pantry, have launched their own weekly distributions using the foundation's model. We provide:

- Operational guidance
- Supplier introductions
- Monthly check-ins

They own their programmes completely — we just helped them start.

### What's Next

We are developing a **Pantry Starter Kit** — a resource pack that any community group can use to launch a dignified, community-run food distribution point. Expected release: Q1 2026.`,
    published: true,
